...
func getYearByYearHittingStats(batterId int) *ncaa.PlayerHittingStats {
...
func getTeamNameMaxLen(splits []ncaa.HittingStatsSplit) int {
	teamNameMaxLen := 0
...
func buildYearByYearHittingStatsTable(hittingStats []ncaa.HittingStatsSplit, width int) table.Model {
...
func statSplitToYearByYearHittingRow(split ncaa.HittingStatsSplit) table.Row {
...
func yearByYearStatsSplitsToTableRows(splits []ncaa.HittingStatsSplit) []table.Row {
	var rows []table.Row
